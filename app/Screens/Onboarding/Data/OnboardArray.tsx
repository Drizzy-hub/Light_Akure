...
export const CarouselPaths: imagePath[] = [
	{
		...
		BigText: 'Welcome to FutaTab',
		normal:
			'Check your areas for real-time power availability and stay informed on-the-go.',
		btn1: 'Next',
		btn2: 'Skip',
		icon: 'onboard-one',
	},
	{
		...
		normal:
			'Real-time insights into your surroundings with our advanced light monitoring feature',
		btn1: 'Next',
		btn2: 'Skip',
		icon: 'onboard-two',
	},
	{
		...
		normal:
			'Tailored preferences with notifications and  settings adjustments.',
		btn1: 'Get Started',
		btn2: 'Sign in',
		pathOne: 'Signup',
		pathTwo: 'Login',
